...
\begin{equation}\protect\hypertarget{eq:cosines}{}{ \begin{align}
P_{A+ B+} &= |\langle 2|2\rangle|^2_{A+ B+} = 2(1 + v \cos(\theta)) \\
P_{A+ B-} &= |\langle 2|2\rangle|^2_{A+ B-} = 2(1 - v \cos(\theta)) \notag \\
P_{A- B+} &= |\langle 2|2\rangle|^2_{A- B+} = 2(1 - v \cos(\theta)) \notag \\
P_{A- B-} &= |\langle 2|2\rangle|^2_{A- B-} = 2(1 + v \cos(\theta)) \notag \\ \notag
\end{align}
}\label{eq:cosines}\end{equation}
...
\begin{equation}\protect\hypertarget{eq:simple}{}{ a + b }\label{eq:simple}\end{equation}

this is a simple reference to Eq.~\ref{eq:simple}
