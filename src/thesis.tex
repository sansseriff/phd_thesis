...
\item
  ...
  {\(\Omega\) (3 pts), \(\theta\) (3 pts), and P (3 pts).}
\item
...
laboratory temperature \(T\) is 293\textasciitilde K, lens focal length
\(l\) is \(18~\text{mm}\), detector radius \(r\) is
\(5~\mathrm{\upmu m}\), and the diameter \(d\) of all optics is 1 inch.
The maximum count rate of this SNSPD is 10 MHz. Is the detector usable
or overexposed?
