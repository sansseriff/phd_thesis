...
This analysis is performed in the functions named \texttt{determine\_ppm\_properties} and \texttt{determine\_regular\_properties} for the PPM and QKD applications, respectively.
