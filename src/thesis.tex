...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fig }\OperatorTok{=}\NormalTok{ plt.figure(layout}\OperatorTok{=}\StringTok{"constrained"}\NormalTok{)}
\NormalTok{ax\_dict }\OperatorTok{=}\NormalTok{ fig.subplot\_mosaic(}
\NormalTok{    [}
\NormalTok{        [}\StringTok{"bar"}\NormalTok{, }\StringTok{"plot"}\NormalTok{],}
\NormalTok{        [}\StringTok{"hist"}\NormalTok{, }\StringTok{"image"}\NormalTok{],}
\NormalTok{    ],}
\NormalTok{)}
\NormalTok{ax\_dict[}\StringTok{"bar"}\NormalTok{].bar([}\StringTok{"a"}\NormalTok{, }\StringTok{"b"}\NormalTok{, }\StringTok{"c"}\NormalTok{], [}\DecValTok{5}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{9}\NormalTok{])}
\NormalTok{ax\_dict[}\StringTok{"plot"}\NormalTok{].plot([}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{])}
\NormalTok{ax\_dict[}\StringTok{"hist"}\NormalTok{].hist(hist\_data)}
\NormalTok{ax\_dict[}\StringTok{"image"}\NormalTok{].imshow([[}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{], [}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{]])}
\NormalTok{identify\_axes(ax\_dict)}
\end{Highlighting}
\end{Shaded}
