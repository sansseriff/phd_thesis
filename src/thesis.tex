...
This analysis is performed in the functions \texttt{determine}-\texttt{\_ppm\_properties} and \texttt{determine\_regular\_properties} for the PPM and QKD applications, respectively.
