...
This analysis is performed in the functions \texttt{determine\_ppm\_properties} and \texttt{determine\_regular}-\texttt{\_properties} for the PPM and QKD applications, respectively.
