...
This analysis is performed in the functions named `determine_ppm_properties` and `determine_regular_properties` for the PPM and QKD applications, respectively. 
