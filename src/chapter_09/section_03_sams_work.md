...
![**Michaelson interferometer model** Model for Michaelson interferometers employed in the experiment. The interfomerter contains a beamsplitter with transmittance $t$ and two mirrors with efficiencies $\alpha$ and $\beta$.](./figs/fig_file_name.svg){#fig:fig_id short-caption='Michaelson interferometer model' width=100% path="chapter_09"}
