...
The system was designed around the use of two types of ultra-high-rejection custom short-pass filters, with two each having passbands below $1.6 \mathrm{\upmu m}$ and $1.9 \mathrm{\upmu m}$ (Andover Corp.). As shown in Fig. [1](#fig:dcrmin_filters) b, any mid-IR passbands of one filter complement a high rejection spectral region of the other. They reject wavelengths shorter than $3 \ \mathrm{\upmu m}$ through reflective optical coatings, and attenuate longer wavelengths through material absorption in the N-BK7 glass substrate. Since the filtering depends on the attenuation of the glass itself, the filters are unusually thick, measuring 12.7 mm.
