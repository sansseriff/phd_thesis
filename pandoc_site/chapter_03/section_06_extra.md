...
<figure markdown> 
    ...
    <img alt="fig:rise_exp" style="width: 100%; margin: auto;" src="../figs/rise_exp_light.svg#only-light" >
    <img alt="fig:rise_exp" style="width: 100%; margin: auto;" src="../figs/rise_exp_dark.svg#only-dark" > 
