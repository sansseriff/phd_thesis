...
Our findings can be leveraged in the development of future high-rate heralded SPDC sources. In this context, we see a particular design for such a source, as shown in Fig. [1](#fig:final_setup), to be particularly promising.
